...
//    private ChatService chatservice;
	...
	public Object exist(@PathVariable String nickname, @PathVariable int pagenum)
		...
		if (user.getTeam().getTeamid() == 1) {
			...
			teamdata = new TeamData(user.getTeam().getTeamid(), user.getTeam().getCreateDate(),
					user.getTeam().getMemberCnt(), mems, user.getTeam().getTeamIntro(), user.getTeam().getTitle(),
					user.getTeam().getPreferProject(), preferTech, leaderNickname);
	...
	public Object teamInfo(@PathVariable int teamid) throws MalformedURLException, IOException {
		...
		System.out.println(leaderNickname.getNickname());
		TeamData teamdata = new TeamData(team.getTeamid(), team.getCreateDate(), team.getMemberCnt(), mems,
				team.getTeamIntro(), team.getTitle(), team.getPreferProject(), preferTech, leaderNickname);
	...
	public void modify(@PathVariable int teamid, @Valid @RequestParam String title, String teamintro, int cnt,
			int prePro, Boolean[] preTech, String nickname) {
